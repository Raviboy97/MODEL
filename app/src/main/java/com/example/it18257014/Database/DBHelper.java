package com.example.it18257014.Database;
...
// Which row to update, based on the title
    ...
    public List readAllInfo(){
        ...
        String username = "ravindu";
        //To read we use getReadable
...
// How you want the results sorted in the resulting Cursor
        ...
        while(cursor.moveToNext()) {
            String user = cursor.getString(cursor.getColumnIndexOrThrow(UserProfile.Users.COLUMN_1));
            String dob = cursor.getString(cursor.getColumnIndexOrThrow(UserProfile.Users.COLUMN_1));
            String pass = cursor.getString(cursor.getColumnIndexOrThrow(UserProfile.Users.COLUMN_1));
            String gender = cursor.getString(cursor.getColumnIndexOrThrow(UserProfile.Users.COLUMN_1));
            userInfo.add(user);//0
            userInfo.add(dob);//1
            userInfo.add(pass);//2
